...
const Leftbar = () => {
    ...
    return (
        <div className='h-screen w-1/6 flex justify-center items-center flex-col bg-purple-200 pt-10'>
            <div className='h-5/6 w-full flex flex-col justify-start items-center gap-4'>
                {
                    AdminLinks.map((data, index) => (
                        <NavLink key={index} to={data.link} className='p-5 border-b-4 border-purple-800 hover:border-primary font-bold mt-2 w-full'>
            ...
            <Button  onClick={()=>handleNavigation("/")} className="bg-purple-600 border-black">Logout</Button>
            </div>
